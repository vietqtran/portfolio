                ...
                <div className='z-0 flex items-center p-4 pb-40'>
                    ...
                    <div className='m-0 p-0'>
                        <p id='my-p-element-code' className='ml-5 block w-full translate-y-[-1px] whitespace-normal pr-5 text-white'>
                            ...
                            <span className='text-white'>{`{ workExperience }`}</span>
                            <span className='text-pink-400'> from </span>
                            <span className='text-yellow-200'> './work-experience'</span>; <br />
                            <span className='text-pink-400'>import </span>
                            <span className='text-white'>{`{ education }`}</span>
                            <span className='text-pink-400'> from </span>
                            <span className='text-yellow-200'> './education'</span>; <br /><br />
                            <span className='text-pink-400'>export </span>
                            <span className='text-white'>{`{ education, workExperience }`}</span>
                        </p>
                    </div>
                </div>
            </div>
